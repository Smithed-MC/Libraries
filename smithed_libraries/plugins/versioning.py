...
def resolve_func(
    ctx: Context, namespace, version, scoreholder, version_parts, scheduled
):
...
def enumerate_func(ctx: Context, scoreholder: str, namespace: str, version: str):
...
def replace_version(ctx: Context, namespace: str, version: str):
...
def resolve_advancements(
    ctx: Context, version: str, version_parts, namespace, scoreholder
):
    # breakpoint()
...
def resolve_other(ctx: Context, version: str):
    # predicates
...
def load_tags(ctx: Context, namespace: str):
...
def run(ctx: Context):
    ...
    resolve_func(ctx, namespace, version, scoreholder, version_parts, scheduled)
    enumerate_func(ctx, scoreholder, namespace, version)
...
def beet_default(ctx: Context):
    ...
    ctx.meta["generate_prefix"] = f"impl/{ctx.project_version}"
