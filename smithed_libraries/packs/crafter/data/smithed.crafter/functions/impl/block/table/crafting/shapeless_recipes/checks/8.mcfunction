...
execute if score $temp1 smithed.data matches 0 store result storage smithed.crafter:main root.temp.simplified[8].count int -1 run data get storage smithed.crafter:main root.temp.simplified[8].count -1.000001
