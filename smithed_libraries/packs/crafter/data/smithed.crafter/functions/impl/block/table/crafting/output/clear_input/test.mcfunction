...
data remove entity @s equipment.mainhand
scoreboard players set $temp smithed.data 0
data modify entity @s equipment.mainhand set from block ~ ~ ~ Items[{Slot:21b}]
function smithed.crafter:impl/block/table/crafting/output/clear_input/advanced
...
execute if score $temp smithed.data matches 1 run data modify block ~ ~ ~ Items[{Slot:22b}] set from entity @s equipment.mainhand
