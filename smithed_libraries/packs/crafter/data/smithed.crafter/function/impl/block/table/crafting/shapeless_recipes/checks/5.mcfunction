...
execute if score $temp1 smithed.data matches 0 store result score $temp_count smithed.data run data get storage smithed.crafter:main root.temp.simplified[5].count
execute if score $temp1 smithed.data matches 0 run scoreboard players add $temp_count smithed.data 1
execute if score $temp1 smithed.data matches 0 store result storage smithed.crafter:main root.temp.simplified[5].count int 1 run scoreboard players get $temp_count smithed.data
