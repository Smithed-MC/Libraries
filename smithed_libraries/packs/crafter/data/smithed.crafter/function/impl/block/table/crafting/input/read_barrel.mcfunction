...
function smithed.crafter:impl/block/table/crafting/input/handle_tags

function smithed.crafter:impl/block/table/crafting/input/process

function smithed.crafter:impl/block/table/crafting/recipes

execute if data storage smithed.crafter:main root.temp.crafting_input{0:[{}],1:[{}],2:[{}]} unless data storage smithed.crafter:main root.temp.crafting_input{0:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}],1:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}],2:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}]} if entity @s[scores={smithed.data=0}] run function smithed.crafter:impl/block/table/crafting/input/mirror

execute if data storage smithed.crafter:main root.temp.crafting_input{0:[{}],1:[{}],2:[]} unless data storage smithed.crafter:main root.temp.crafting_input{0:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}],1:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}]} if entity @s[scores={smithed.data=0}] run function smithed.crafter:impl/block/table/crafting/input/mirror

execute if data storage smithed.crafter:main root.temp.crafting_input{0:[{}],1:[],2:[]} unless data storage smithed.crafter:main root.temp.crafting_input{0:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}]} if entity @s[scores={smithed.data=0}] run function smithed.crafter:impl/block/table/crafting/input/mirror

execute if entity @s[scores={smithed.data=0}] run function smithed.crafter:impl/block/table/crafting/shapeless_recipes
...
execute if entity @s[scores={smithed.data=1..}] run data modify entity @s equipment.head.components."minecraft:custom_data".smithed.stored_output set from block ~ ~ ~ Items[{Slot:16b}]
