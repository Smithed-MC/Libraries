# loop every tick
schedule function smithed.actionbar:impl/technical/tick 1t replace

# reset scores when at 1
execute as @a[scores={smithed.actionbar.freeze=1}] run function smithed.actionbar:impl/reset
