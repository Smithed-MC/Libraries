...
execute if score $locked smithed.actionbar.temp matches 0 if block ~ ~ ~ #smithed.actionbar:__version__/chests unless block ~ ~ ~ #smithed.actionbar:__version__/chests[type=single] run function smithed.actionbar:impl/vanilla/container/check_double_chest_lock
