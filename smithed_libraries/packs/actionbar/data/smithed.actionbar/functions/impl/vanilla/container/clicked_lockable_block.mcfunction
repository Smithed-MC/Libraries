...
# revoke advancement
advancement revoke @s only smithed.actionbar:impl/vanilla/container/clicked_lockable_block

# find block that was clicked
scoreboard players set $ray smithed.actionbar.temp 50
execute anchored eyes positioned ^ ^ ^ run function smithed.actionbar:impl/vanilla/container/raycast
