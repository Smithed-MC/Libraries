...
execute as @a[x=0] run function smithed.actionbar:impl/__version__/vanilla/send_message
...
schedule function smithed.actionbar:impl/__version__/vanilla/bed/track_leave_bed 1t replace
