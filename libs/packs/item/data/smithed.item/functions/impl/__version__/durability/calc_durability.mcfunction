...
function smithed.item:impl/__version__/durability/get_max
...
execute if score $temp1 smithed.data matches 1.. if data storage smithed.item:main item.tag.Enchantments[{id:"minecraft:mending"}] run function smithed.item:impl/__version__/durability/calc_mending
...
function smithed.item:impl/__version__/lore/build
