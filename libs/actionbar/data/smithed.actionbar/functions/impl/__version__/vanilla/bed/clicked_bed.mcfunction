...
execute if entity @s[tag=!smithed.actionbar.sleeping] run function smithed.actionbar:impl/__version__/vanilla/send_message

# else send sleeping message
execute if entity @s[tag=smithed.actionbar.sleeping] run function smithed.actionbar:impl/__version__/vanilla/bed/check_sleep_status
