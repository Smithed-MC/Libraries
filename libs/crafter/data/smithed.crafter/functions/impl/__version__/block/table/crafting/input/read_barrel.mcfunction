...
execute if data storage smithed.crafter:main root.temp.crafting_input{0:[{}],1:[],2:[]} unless data storage smithed.crafter:main root.temp.crafting_input{0:[{id:"minecraft:air",Slot:1b},{id:"minecraft:air",Slot:2b}]} if entity @s[scores={smithed.data=0}] run function smithed.crafter:impl/__version__/block/table/crafting/input/mirror
