...
execute if score $temp2 smithed.data matches 1..64 run function smithed.crafter:impl/__version__/block/table/crafting/output/shift_click/calculate_extras
