...
execute if entity @s[predicate=smithed.crafter:block/table/invalid_items] run function smithed.crafter:impl/__version__/block/table/crafting/manage_invalids/export
