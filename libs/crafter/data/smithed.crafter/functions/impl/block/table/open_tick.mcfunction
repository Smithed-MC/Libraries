...
execute if entity @s[predicate=smithed.crafter:block/table/invalid_items] run function smithed.crafter:impl/__version__/block/table/crafting/manage_invalids/move
...
execute if entity @s[scores={smithed.data=1..}] if data block ~ ~ ~ Items run function smithed.crafter:impl/__version__/block/table/crafting/input/read_barrel
