...
data modify storage smithed:crafter root.temp.Inventory set from entity @s Inventory
execute store result score @s smithed.data run data get entity @s Inventory
function smithed.crafter:impl/__version__/block/table/crafting/output/cursor_check/loop
