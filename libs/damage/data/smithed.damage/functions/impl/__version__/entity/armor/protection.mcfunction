...
execute store result score #helm smithed.damage run data get storage smithed.damage: temp.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
execute store result score #chest smithed.damage run data get storage smithed.damage: temp.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
execute store result score #legs smithed.damage run data get storage smithed.damage: temp.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
execute store result score #boots smithed.damage run data get storage smithed.damage: temp.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:protection"}].lvl
